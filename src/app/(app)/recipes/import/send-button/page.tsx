...
export const metadata = { title: "Send to Dinner Roulette" };
...
export default async function SendButtonPage() {
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-5">
      ...
      <PageHeader
        title="“Send to Dinner Roulette” button"
      ...
      <Card className="space-y-2 text-sm">
        ...
        <ol className="ml-5 list-decimal space-y-1">
          ...
          <li>Open your bookmarks and tap <strong>Send to Dinner Roulette</strong>.</li>
